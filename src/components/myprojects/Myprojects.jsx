...
export default function Myprojects() {
  ...
  const showMoreText = Language.projects.button2[language];
  const showLessText = Language.projects.button1[language];
  const showMoreSign = <BsChevronDoubleDown />;
  const showLessSign = <BsChevronDoubleUp />;
    ...
    <section id='projects' className='w-screen bg-dark-blue flex flex-col justify-items-center items-center'>
      <div className='flex w-10/12 flex-col justify-items-center items-center basis-1/2 text-center lg:w-8/12'>
        ...
        <h3
          ...
          className='bg-show-more hover:bg-show-more-hover bg-center bg-cover text-blue font-semibold text-lg lg:text-xl w-44 h-20 pt-6 mt-10'>
          { showMore ? `${showMoreText} ${showMoreSign}` : `${showLessText} ${showLessSign}`}
        </h3>
      </div>
