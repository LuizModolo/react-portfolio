  ...
  return (
    <section id='about' className='w-screen dark-blue flex flex-col justify-items-center items-center'>
      <div className='flex w-10/12 flex-col basis-1/2 text-center lg:w-8/12'>
        <h1 className='text-orange mt-20 font-medium text-3xl sm:text-4xl lg:mt-24'>{Language.about.title[language]}</h1>
        <p className='text-grey font-poppins mt-6 font-normal text-lg sm:text-xl lg:mt-10'>{Language.about.text[language]}</p>
      </div>
