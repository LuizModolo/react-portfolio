  ...
  return (
    <section id='skills' className='w-screen bg-blue flex flex-col justify-items-center items-center'>
      <div className='flex w-10/12 flex-col justify-items-center items-center basis-1/2 text-center lg:w-8/12'>
        <h1 className='text-yellow mt-8 font-medium text-3xl sm:text-4xl lg:mt-24'>{language.skills.title[idiom]}</h1>
        <p className='text-grey font-poppins mt-6 font-normal text-lg sm:text-xl lg:mt-10'>{language.skills.text[idiom]}</p>
